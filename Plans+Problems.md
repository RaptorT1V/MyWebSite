# № – Не работает добавление товаров через админку. Выдаёт ошибку
...
Личные сообщения тоже как идея интересная. Потому что уже есть задел: в game можно тыкнуть на имя профиля и перейти на его страницу.
...
### №3 – Визуализатор музыкальной дорожки на странице musician_resume.html
Он просто должен выглядеть красивее и аккуратнее.

### №4 – Разукрасить магнетизм на странице home.html
...
### №5 – Курсор должен меняться на красный (aim2.png) при зажатии ЛКМ в любой точке <div class="main-content-custom"> на странице home.html
А сейчас пока только в области gravity-text

### №6 – Доп. стили для forum
